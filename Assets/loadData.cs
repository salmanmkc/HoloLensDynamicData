    ...
    protected virtual async void OnTrackingFound()
    {
            ...
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    temperature = parseddata.data.asset.readings[0].values[0].values[0];
                    humidity = parseddata.data.asset.readings[1].values[0].values[0];
                    //string test = parseddata.data.assets[0].type;
                    string toBreakpoint = "";
                    gameObject.GetComponent<loadData>().temperatureVal = temperature;
                    gameObject.GetComponent<loadData>().humidityVal = humidity;
